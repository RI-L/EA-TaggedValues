...
''' ===========================================================================
'''
''' VERSION			: 0.9.7, 20200928 - Updated desription text.
...
'''
''' LICENSE			: MIT. (C) Rolf Lampa, 2015. Free to use for commercial
'''				  	  projects if giving proper attribution to the author by 
'''					  providing this copyright info visible in your code and 
...
'''					  "TaggedValue_Test.vbs" for basic property read access.
'''
''' ---------------------------------------------------------------------------
'''
